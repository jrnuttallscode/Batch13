...
//ingredients of the hamburger, name, meat, price, and breadRollType. The price variable should 
//be of type double, while the other three are of type String. A constructor will be needed to 
//accept these four values as parameters when creating a new hamburger.
//
...
//addition2Price, addition3Name, addition3Price, addition4Name, and addition4Price. The name 
...
//hamburger with addons, if any, and the total price. Remember that a name and price must be accepted 
//as parameters in the first four methods so that the price of the hamburger is adjusted accordingly. 
//These methods should be named addHamburgerAddition1, addHamburgerAddition2, addHamburgerAddition3, 
//addHamburgerAddition4, and itemizehamburger. The first four methods do not return values, but the 
...
//accepts no parameters. Instead, the constructor creates a deluxe burger with all the fixings and c
//hips and a drink for a base price of $19.10. The constructor can be configured in any way, as long as 
//chips and drink are added for the total price just mentioned. In this class, the four(4) methods defined 
//in the Hamburger class for including additional toppings must each be overridden so that a message 
...
//healthyExtra1Name, healthyExtra1Price, healthyExtra2Name, and healthyExtra2Price. The names are 
...
public class BillsBurgers {
	...
	class Hamburger {
		...
		void addHamburgerAddition2() {
			// TODO Auto-generated method stub
			
		}

		void addHamburgerAddition1() {
			// TODO Auto-generated method stub
			
		}

		public void add(String addition1Name, double addition1Price, String addition2Name, 
				double addition2Price, String addition3Name, double addition3Price, String addition4Name, 
				double addition4Price) {
			...
			this.addition4Name = addition4Price;
		...
		public double itemizehamburger(String itemizedList, double totalPrice) {
			return totalPrice;
...
class DeluxeBurger extends Hamburger{
	...
	public DeluxeBurger(String deluxeBurgerCombo, double deluxeComboPrice) {
		super(deluxeBurgerCombo, deluxeBurgerCombo, deluxeComboPrice, deluxeBurgerCombo);
		DeluxeBurger dB= new DeluxeBurger(deluxeBurgerCombo, deluxeComboPrice);
...
class HealthyBurger {
	...
	public HealthyBurger(String healthyExtra1Name, double healthyExtra1Price, String healthyExtra2Name, double healthyExtra2Price) {
	...
	void addHealthyAddition1(String healthyExtra1Name, double healthyExtra1Price) {
		
	}
	
	void addHealthyAddition2(String healthyExtra2Name, double healthyExtra2Price) {
